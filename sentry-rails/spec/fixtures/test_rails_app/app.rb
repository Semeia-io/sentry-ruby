...
when -> (v) { v < v5_2 }
  require "fixtures/test_rails_app/apps/5-0"
when -> (v) { v.between?(v5_2, v6_0) }
  require "fixtures/test_rails_app/apps/5-2"
when -> (v) { v.between?(v6_0, v6_1) }
  require "fixtures/test_rails_app/apps/6-0"
when -> (v) { v.between?(v6_1, v7_0) }
  require "fixtures/test_rails_app/apps/6-1"
when -> (v) { v.between?(v7_0, v7_1) }
  require "fixtures/test_rails_app/apps/7-0"
end
...
def make_basic_app(&block)
  ...
  app.config.action_controller.view_paths = "spec/fixtures/test_rails_app"
